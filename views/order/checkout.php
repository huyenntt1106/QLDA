        ...
        <form action="?act=place-order&id=<?= $_SESSION["user"]['id'] ?>" method="post">
            <div class="row d-flex gap-5">
                <div class="col-12 col-sm-5">
                    ...
                    <h5 class="text-secondary text-center pt-5 mb-4">Thanh toán nhanh với:</h5>
                    ...
                    <h5 class="text-secondary text-center mt-4">hoặc</h5>

                    <div class="mt-5 pb-4 border-bottom">
                        <h3 class="fs-2 fw-bold">Tài khoản</h3>
                        <div class="d-flex flex-wrap justify-content-between align-items-center lh-base pt-2">
                            ...
                            <div id="span">
                                <a href="?act=logout" class="link-hover-100">Đăng xuất</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 pb-4 fs-4 border-bottom">
                        ...
                        <?php endif; ?>
                        <h3 class="fs-2 pb-2 fw-bold">Khách hàng
                    ...
                    <div class="mt-5 pb-4 fs-4">
                        <label for="note" class="form-label fs-3 fw-semibold">Ghi chú</label>
                        <textarea id="note" name="note" class="form-control fs-3" rows="4" cols="50" placeholder="Chúng tôi có thể giúp gì cho bạn?"></textarea>
                    </div>

                    <div class="mt-5 pb-4 fs-4">
                        <h3 class="fs-2 fw-bold">Thanh toán</h3>
                        <p class="text-secondary py-4">Tất cả các giao dịch đều được bảo mật và mã hóa.</p>
                    ...
                    <div class="hide-on-mobile">
                        <button type="submit" name="btnOrder" style="letter-spacing: 1px;" class="btn btn-danger fs-3 fw-bold py-3 w-100 mb-5">ĐẶT HÀNG</button>
                        <ul class="d-flex flex-wrap gap-3 justify-content-between mb-5">
                            <a href="" class="text-danger fs-5 text-decoration-underline">ĐIỀU KHOẢN</a>
                            <a href="" class="text-danger fs-5 text-decoration-underline">CHÍNH SÁCH BẢO MẬT</a>
                            <a href="" class="text-danger fs-5 text-decoration-underline">ĐỔI/TRẢ HÀNG</a>
                            <a href="?act=contact" class="text-danger fs-5 text-decoration-underline">LIÊN LẠC</a>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="p-5 position-sticky top-0">
                                    ...
                                    <div class="cart-item mb-4 border-0" style="height: 80px;">
                                        ...
                                        <div class="w-100 p-3 d-flex flex-wrap align-items-center justify-content-between">
                                            ...
                                            <div class="d-flex flex-column align-items-end lh-base">
                                                ...
                                                <span class="fs-3 fw-semibold"><?= number_format($totalPrice, 0, '.', ',') ?> VNĐ</span>
                            ...
                            <div class="form__group d-flex gap-2 mt-5">
                                <div class="form__group m-0 w-100">
                                    <input type="text" id="giftCard" name="giftCard" placeholder="Mã giảm giá hoặc thẻ quà tặng" autocomplete="giftCard">
                                    <label for="giftCard" style="background-color: #f5f5f5;">Mã giảm giá hoặc thẻ quà tặng</label>
                                </div>
                                <button type="submit" class="btn btn-outline-dark fs-4 fw-bold px-4">Áp dụng</button>
                            </div>
                            ...
                            <div class="mt-4 lh-lg">
                                ...
                                <div class="fs-3 d-flex justify-content-between">
                                    <span>Tạm tính</span>
                                    <span><?= number_format($subtotal, 2, '.', ',') ?> VNĐ</span>
                                </div>
                                <div class="fs-3 d-flex justify-content-between">
                                    <?php
                                    ...
                                    ?>
                                    <span>
                                        <span>Phí vận chuyển<i class="fa-regular fa-circle-question fs-4 ms-2" data-bs-toggle="modal" data-bs-target="#exampleModal" style="cursor: pointer;"></i></span>
                                        <span class="text-secondary">
                                            <?php 
                                            if (!empty($normalizedCustomerCity)) {
                                                $nonurban = ($normalizedCustomerCity === $normalizedTargetCity) ? '' : 'Ngoại thành';
                                            } 
                                            ?>
                                            <?= $nonurban ?? '' ?>
                                        </span>
                                    ...
                                    $shipping = 0;
                                    if (empty($normalizedCustomerCity)) {
                                        echo '<span>Đang tính toán...</span>';
                                    } else {
                                        $shipping = ($normalizedCustomerCity === $normalizedTargetCity) ? 0 : 20;
                                        echo '<span>' . number_format($shipping, 2, '.', ',') . ' VNĐ</span>';
                                    }
                                    ?>
                                </div>
                                <div class="fs-2 fw-bold d-flex justify-content-between">
                                    ...
                                    <span><?= number_format($total, 2, '.', ',') ?> VNĐ</span>
                            ...
                            <div class="cart-item mb-4 border-0" style="height: 80px;">
                                ...
                                <div class="w-100 p-3 d-flex flex-wrap align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex flex-column align-items-end lh-base">
                                        ...
                                        <span class="fs-3 fw-semibold"><?= number_format($totalPrice, 0, '.', ',') ?> VNĐ</span>
                                        <span class="fs-4 text-secondary">x<?= number_format($data['price'], 0, '.', ',') ?> VNĐ</span>
                                    </div>
                                </div>
                            </div>
                            <div class="form__group d-flex gap-4 mt-5">
                                <input type="text" id="discountCode" name="fieldDiscountCode" placeholder="Mã giảm giá hoặc thẻ quà tặng">
                                <button type="submit" class="btn btn-outline-dark fs-4 fw-bold px-4">Áp dụng</button>
                            </div>
                            <div class="mt-4 lh-lg">
                                <div class="fs-3 d-flex justify-content-between">
                                ...
                                <div class="fs-2 fw-bold d-flex justify-content-between">
                                    <span>Tổng: </span>
                                    <span><?= number_format($totalPrice + $shipping, 2, '.', ',') ?> VNĐ</span>
                                    <input type="hidden" name="total" value="<?= $totalPrice ?>">
                                </div>
                            </div>

                            <div class="mt-5 hide-on-pc hide-on-tablet">
                                <button style="letter-spacing: 1px;" class="btn btn-danger fs-3 fw-bold py-3 w-100 mb-5">ĐẶT HÀNG</button>
                                <ul class="d-flex flex-wrap gap-3 justify-content-between mb-5">
                                    <a href="" class="text-danger fs-5 text-decoration-underline">ĐIỀU KHOẢN DỊCH VỤ</a>
                                    <a href="" class="text-danger fs-5 text-decoration-underline">CHÍNH SÁCH BẢO MẬT</a>
                                    <a href="" class="text-danger fs-5 text-decoration-underline">CHÍNH SÁCH ĐỔI/TRẢ HÀNG</a>
                                    <a href="?act=contact" class="text-danger fs-5 text-decoration-underline">LIÊN LẠC</a>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h2 class="modal-title fw-bold" id="exampleModalLabel">Chính sách vận chuyển</h2>
                <button type="button" class="btn-close me-2" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body pt-0 pb-5">
                <p align="justify" class="lh-sm">
                     Chúng tôi vui mừng thông báo với bạn rằng mọi đơn hàng gửi đến Hà Nội sẽ không còn chịu thuế địa phương
                    và
                    phí vận chuyển. Điều này sẽ giúp bạn tiết kiệm chi phí khi mua hàng. Xin lưu ý rằng những
                    quy định
                    chỉ áp dụng cho các đơn hàng nội địa tại Việt Nam và không áp dụng cho vận chuyển quốc tế.
                </p>
                <h5 class="py-4">Bạn có chấp nhận đổi/ trả hàng không?</h5>
                <span>Nếu có, vui lòng xem <a href="" class="text-danger fs-5 text-decoration-underline">CHÍNH SÁCH ĐỔI/TRẢ HÀNG</a></span>
            </div>
        </div>
    </div>
</div>
