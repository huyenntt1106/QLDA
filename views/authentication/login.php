            ...
            <form action="" method="post">
                ...
                <div class="form__group form__group-option">
                    <div class="form__check">
                        ...
                        <label for="stayLoggedIn">Nhớ mật khẩu</label>
                    </div>
                    <a href="?act=forgot-password" class="form__group-link btnForgot">Quên mật khẩu?</a>
                </div>
                <div class="form__group">
                    <button class="btn-submit" name="btnLogin" type="submit">Đăng nhập</button>
                </div>
                <div class="form__group">
                    <span>
                        Chưa có tài khoản?
                        <a class="form__group-link fw-bold text-danger" href="?act=register">Đăng ký</a>
                    </span>
                </div>
            </form>
        </div>
