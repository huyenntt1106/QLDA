        ...
        <div class="form-container">
            <div class="form-heading">
                ...
                <?php if (isset($_SESSION['email'])) : ?>
                    ...
                    Chúng tôi đã gửi cho bạn một email hướng dẫn đặt lại mật khẩu.
                    </div>
                <?php endif; ?>
            ...
            <form action="" method="post">
                ...
                <div class="form__group">
                    <button class="btn-submit" name="btnRecover" type="submit">Xác Nhận</button>
                </div>
                <?php if (empty($_SESSION["user"])) : ?>
                    <div class="form__group">
                        <span>
                            Nhớ mật khẩu?
                            <a href="?act=login" class="form__group-link btnBackToLogin fw-bold">Quay lại đăng nhập</a>
                        </span>
                    </div>
                <?php endif; ?>
            </form>
